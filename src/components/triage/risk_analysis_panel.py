...
def render_risk_analysis_panel(patient_data, enable_predictive=True):
    ...
    with st.expander("🛡️ Análisis de Riesgos (Pre-Triaje)", expanded=True):
        ...
        with col_btns:
            ...
            if st.button("Verificar riesgos con IA", type="primary", help="Analizar signos vitales con IA", key="btn_predictive_check_ai", use_container_width=True):
            ...
            if st.button("🔍 Analizar AMBOS", help="Ejecutar ambos análisis y comparar", key="btn_predictive_check_both", use_container_width=True):
                with st.spinner("Ejecutando análisis completo..."):
                    ...
                    res_algo = {"status": "SUCCESS", "risk_level": risk_algo, "alerts": alerts_algo}
